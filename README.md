...
- [lantern](https://lantern-snowy.vercel.app) - あなたの悩みを過去に乗り越えた人と話せる。匿名音声マッチングアプリ (Next.js + Supabase)

- [kagebunshin](https://kagebunshin-beryl.vercel.app) - 資料を放り込むだけ。メッシュデータ構造で仕事をサポートする専属AI (Next.js + Supabase)
